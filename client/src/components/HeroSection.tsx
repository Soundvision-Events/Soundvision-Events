    ...
    >
      ...
      <div className="absolute inset-0" style={{ opacity: 0.4 }}>
        <video
          ...
          style={{ position: "absolute", top: 0, left: 0, width: "100%", height: '1038px', objectFit: "cover", marginTop: '-120px', marginRight: '92px', marginBottom: '-49px', marginLeft: '4px', backgroundColor: '#07006b' }}
