...
const packages = [
  {
    ...
    photoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663484862365/6RH3PKVEJrkwHnmCKCLqmc/intiem_show_template_v2_75b64794.png",
    features: [
  ...
  },
  {
    ...
    photoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663484862365/6RH3PKVEJrkwHnmCKCLqmc/luxe_show_template_16cc28b3.png",
    features: [
...
export default function UitbreidingenSection({ showOpeningsdansMix = false, theme = DEFAULT_THEME }: { showOpeningsdansMix?: boolean; theme?: PageTheme }) {
  ...
  return (
    <section id="packages" style={{ position: "relative", padding: "6rem 0", overflow: "hidden", backgroundColor: 'rgba(0,19,36,0.5)' }}>
